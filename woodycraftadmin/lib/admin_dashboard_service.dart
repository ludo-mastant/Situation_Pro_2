...
class DashboardResume {
  ...
  factory DashboardResume.fromJson(Map<String, dynamic> json) {
    return DashboardResume(
      commandesEnAttente: _toInt(json['commandes_en_attente'] ?? json['commandesEnAttente']),
      puzzlesStockBas: _toInt(json['puzzles_stock_bas'] ?? json['puzzlesStockBas'] ?? json['stock_bas']),
      chiffreAffaireMois: _toDouble(json['chiffre_affaire_mois'] ?? json['chiffreAffaireMois'] ?? json['ventes_mois']),
      totalClients: _toInt(json['total_clients'] ?? json['totalClients'] ?? json['nombre_clients']),
    );
  }
}
